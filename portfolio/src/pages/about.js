...
import { IconCodeDots, IconStack3, IconListCheck, IconCalendarClock, IconGitFork, IconAccessible} from '@tabler/icons-react'
    ...
    return (           
        ...
        <div className="col-xl-8">   
            ...
            <ul className="list-unstyled fs-5">
                ...
                <li className="d-lg-inline me-lg-5">
                    
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vscode/vscode-original.svg" alt="list-item-bullet" className="me-1 dev-icon"/>
                ...
                <li className="d-lg-inline me-lg-5">
                    ...
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/mongodb/mongodb-original.svg" alt="list-item-bullet" className="me-1 dev-icon"/>
                ...
                <li className="d-lg-inline me-lg-5">
                    ...
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/androidstudio/androidstudio-original.svg" alt="list-item-bullet" className="me-1 dev-icon"/>
                ...
                <li className="d-lg-inline me-lg-5">
                    ...
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/photoshop/photoshop-plain.svg" alt="list-item-bullet" className="me-1 dev-icon"/>
                ...
                <li className="d-lg-inline me-lg-5">
                    ...
                    <img src={DrawioSvg} className="me-1 dev-icon" alt="list-item-bullet"/>
            ...
            <ul className="list-unstyled fs-5">
                ...
                <li className="d-lg-inline me-lg-5">
                    ...
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/javascript/javascript-original.svg" alt="list-item-bullet" className="me-1 dev-icon"/>
                ...
                <li className="d-lg-inline me-lg-5">
                    ...
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg" alt="list-item-bullet" className="me-1 dev-icon"/>
                ...
                <li className="d-lg-inline me-lg-5">
                    ...
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/java/java-original.svg" alt="list-item-bullet" className="me-1 dev-icon"/>
                ...
                <li className="d-lg-inline me-lg-5">
                    ...
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/python/python-original.svg" alt="list-item-bullet" className="me-1 dev-icon"/>
                    <span className="align-middle">Python</span>
                    
                </li>

                <li className="d-lgd-inline me-lg-5">
                    
                    <img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/csharp/csharp-original.svg" alt="list-item-bullet" className="me-1 dev-icon"/>
            ...
            <ul className="list-unstyled fs-5">
                ...
                <li className="d-lg-inline me-lg-5">
                    ...
                    <IconAccessible className="me-1 dev-icon"/>
                    <span className="align-middle">Accessible Design</span>
